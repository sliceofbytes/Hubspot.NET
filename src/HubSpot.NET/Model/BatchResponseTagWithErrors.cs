...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchResponseTagWithErrors")]
    public partial class BatchResponseTagWithErrors : IEquatable<BatchResponseTagWithErrors>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponseTagWithErrors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchResponseTagWithErrors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponseTagWithErrors" /> class.
        /// </summary>
        ...
        public BatchResponseTagWithErrors(StatusEnum status = default(StatusEnum), List<Tag> results = default(List<Tag>), int numErrors = default(int), List<TagsStandardError> errors = default(List<TagsStandardError>), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null) {
                throw new ArgumentNullException("results is a required property for BatchResponseTagWithErrors and cannot be null");
            }
        ...
        public List<TagsStandardError> Errors { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchResponseTagWithErrors {\n");
        ...
        {
            return this.Equals(input as BatchResponseTagWithErrors);
        }

        /// <summary>
        /// Returns true if BatchResponseTagWithErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchResponseTagWithErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchResponseTagWithErrors input)
        {
            if (input == null)
            {
                return false;
