...
namespace HubSpot.NET.Model
{
    ...
    public partial class BatchResponseTimelineEventResponseWithErrors : IEquatable<BatchResponseTimelineEventResponseWithErrors>, IValidatableObject
    {
        ...
        public BatchResponseTimelineEventResponseWithErrors(StatusEnum status = default(StatusEnum), List<TimelineEventResponse> results = default(List<TimelineEventResponse>), int numErrors = default(int), List<TimelineStandardError> errors = default(List<TimelineStandardError>), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
        ...
        public List<TimelineStandardError> Errors { get; set; }
