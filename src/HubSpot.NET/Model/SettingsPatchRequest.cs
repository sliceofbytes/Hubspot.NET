...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SettingsPatchRequest")]
    public partial class SettingsPatchRequest : IEquatable<SettingsPatchRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SettingsPatchRequest" /> class.
        /// </summary>
        /// <param name="name">The name of your calling service to display to users..</param>
        /// <param name="url">The URL to your phone/calling UI, built with the [Calling SDK](#)..</param>
        /// <param name="height">The target height of the iframe that will contain your phone/calling UI..</param>
        /// <param name="width">The target width of the iframe that will contain your phone/calling UI..</param>
        /// <param name="isReady">When true, your service will appear as an option under the *Call* action in contact records of connected accounts..</param>
        /// <param name="supportsCustomObjects">When true, you are indicating that your service is compatible with engagement v2 service and can be used with custom objects..</param>
        public SettingsPatchRequest(string name = default(string), string url = default(string), int height = default(int), int width = default(int), bool isReady = default(bool), bool supportsCustomObjects = default(bool))
        {
            this.Name = name;
            this.Url = url;
            this.Height = height;
        ...
        [DataMember(Name = "supportsCustomObjects", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SettingsPatchRequest {\n");
        ...
        {
            return this.Equals(input as SettingsPatchRequest);
        }

        /// <summary>
        /// Returns true if SettingsPatchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SettingsPatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SettingsPatchRequest input)
        {
            if (input == null)
            {
                return false;
