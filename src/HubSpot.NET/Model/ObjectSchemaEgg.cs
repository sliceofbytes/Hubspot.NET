...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ObjectSchemaEgg")]
    public partial class ObjectSchemaEgg : IEquatable<ObjectSchemaEgg>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectSchemaEgg" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ObjectSchemaEgg() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectSchemaEgg" /> class.
        /// </summary>
        ...
        /// <param name="associatedObjects">Associations defined for this object type. (required).</param>
        /// <param name="name">A unique name for this object. For internal use only. (required).</param>
        public ObjectSchemaEgg(ObjectTypeDefinitionLabels labels = default(ObjectTypeDefinitionLabels), List<string> requiredProperties = default(List<string>), List<string> searchableProperties = default(List<string>), string primaryDisplayProperty = default(string), List<string> secondaryDisplayProperties = default(List<string>), List<ObjectTypePropertyCreate> properties = default(List<ObjectTypePropertyCreate>), List<string> associatedObjects = default(List<string>), string name = default(string))
        {
            // to ensure "labels" is required (not null)
            if (labels == null) {
                throw new ArgumentNullException("labels is a required property for ObjectSchemaEgg and cannot be null");
            }
            this.Labels = labels;
            // to ensure "requiredProperties" is required (not null)
            if (requiredProperties == null) {
                throw new ArgumentNullException("requiredProperties is a required property for ObjectSchemaEgg and cannot be null");
            }
            this.RequiredProperties = requiredProperties;
            // to ensure "searchableProperties" is required (not null)
            if (searchableProperties == null) {
                throw new ArgumentNullException("searchableProperties is a required property for ObjectSchemaEgg and cannot be null");
            }
            this.SearchableProperties = searchableProperties;
            // to ensure "secondaryDisplayProperties" is required (not null)
            if (secondaryDisplayProperties == null) {
                throw new ArgumentNullException("secondaryDisplayProperties is a required property for ObjectSchemaEgg and cannot be null");
            }
            this.SecondaryDisplayProperties = secondaryDisplayProperties;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for ObjectSchemaEgg and cannot be null");
            }
            this.Properties = properties;
            // to ensure "associatedObjects" is required (not null)
            if (associatedObjects == null) {
                throw new ArgumentNullException("associatedObjects is a required property for ObjectSchemaEgg and cannot be null");
            }
            this.AssociatedObjects = associatedObjects;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for ObjectSchemaEgg and cannot be null");
            }
            this.Name = name;
        ...
        public List<ObjectTypePropertyCreate> Properties { get; set; }

        /// <summary>
        /// Associations defined for this object type.
        /// </summary>
        /// <value>Associations defined for this object type.</value>
        [DataMember(Name = "associatedObjects", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ObjectSchemaEgg {\n");
            ...
            sb.Append("  AssociatedObjects: ").Append(AssociatedObjects).Append("\n");
        ...
        {
            return this.Equals(input as ObjectSchemaEgg);
        }

        /// <summary>
        /// Returns true if ObjectSchemaEgg instances are equal
        /// </summary>
        /// <param name="input">Instance of ObjectSchemaEgg to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectSchemaEgg input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AssociatedObjects == input.AssociatedObjects ||
                    this.AssociatedObjects != null &&
                    input.AssociatedObjects != null &&
                    this.AssociatedObjects.SequenceEqual(input.AssociatedObjects)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AssociatedObjects.GetHashCode();
                }
                if (this.Name != null)
                {
