...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TimelineEventTemplate")]
    public partial class TimelineEventTemplate : IEquatable<TimelineEventTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimelineEventTemplate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TimelineEventTemplate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TimelineEventTemplate" /> class.
        /// </summary>
        ...
        /// <param name="objectType">The type of CRM object this template is for. [Contacts, companies, tickets, and deals] are supported. (required).</param>
        /// <param name="createdAt">The date and time that the Event Template was created, as an ISO 8601 timestamp. Will be null if the template was created before Feb 18th, 2020..</param>
        /// <param name="updatedAt">The date and time that the Event Template was last updated, as an ISO 8601 timestamp. Will be null if the template was created before Feb 18th, 2020..</param>
        public TimelineEventTemplate(string name = default(string), string headerTemplate = default(string), string detailTemplate = default(string), List<TimelineEventTemplateToken> tokens = default(List<TimelineEventTemplateToken>), string id = default(string), string objectType = default(string), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for TimelineEventTemplate and cannot be null");
            }
            this.Name = name;
            // to ensure "tokens" is required (not null)
            if (tokens == null) {
                throw new ArgumentNullException("tokens is a required property for TimelineEventTemplate and cannot be null");
            }
            this.Tokens = tokens;
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for TimelineEventTemplate and cannot be null");
            }
            this.Id = id;
            // to ensure "objectType" is required (not null)
            if (objectType == null) {
                throw new ArgumentNullException("objectType is a required property for TimelineEventTemplate and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The type of CRM object this template is for. [Contacts, companies, tickets, and deals] are supported.</value>
        ...
        /// </summary>
        /// <value>The date and time that the Event Template was created, as an ISO 8601 timestamp. Will be null if the template was created before Feb 18th, 2020.</value>
        ...
        /// </summary>
        /// <value>The date and time that the Event Template was last updated, as an ISO 8601 timestamp. Will be null if the template was created before Feb 18th, 2020.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TimelineEventTemplate {\n");
        ...
        {
            return this.Equals(input as TimelineEventTemplate);
        }

        /// <summary>
        /// Returns true if TimelineEventTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of TimelineEventTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimelineEventTemplate input)
        {
            if (input == null)
            {
                return false;
