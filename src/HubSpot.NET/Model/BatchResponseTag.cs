...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchResponseTag")]
    public partial class BatchResponseTag : IEquatable<BatchResponseTag>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponseTag" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchResponseTag() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponseTag" /> class.
        /// </summary>
        ...
        public BatchResponseTag(StatusEnum status = default(StatusEnum), List<Tag> results = default(List<Tag>), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null) {
                throw new ArgumentNullException("results is a required property for BatchResponseTag and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchResponseTag {\n");
        ...
        {
            return this.Equals(input as BatchResponseTag);
        }

        /// <summary>
        /// Returns true if BatchResponseTag instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchResponseTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchResponseTag input)
        {
            if (input == null)
            {
                return false;
