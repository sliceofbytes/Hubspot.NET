...
namespace HubSpot.NET.Model
{
    ...
    public partial class SettingsRequest : IEquatable<SettingsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public SettingsRequest(string name = default(string), string url = default(string), int height = default(int), int width = default(int), bool isReady = default(bool), bool supportsCustomObjects = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for SettingsRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "url" is required (not null)
            if (url == null) {
                throw new ArgumentNullException("url is a required property for SettingsRequest and cannot be null");
            }
            this.Url = url;
            this.Height = height;
            this.Width = width;
        ...
        {
            return this.Equals(input as SettingsRequest);
        }

        /// <summary>
        /// Returns true if SettingsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SettingsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SettingsRequest input)
        {
            if (input == null)
            {
                return false;
