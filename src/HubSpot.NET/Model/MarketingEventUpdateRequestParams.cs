...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MarketingEventUpdateRequestParams")]
    public partial class MarketingEventUpdateRequestParams : IEquatable<MarketingEventUpdateRequestParams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketingEventUpdateRequestParams" /> class.
        /// </summary>
        /// <param name="eventName">The name of the marketing event..</param>
        ...
        /// <param name="eventOrganizer">The name of the organizer of the marketing event..</param>
        ...
        [DataMember(Name = "eventOrganizer", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as MarketingEventUpdateRequestParams);
        }

        /// <summary>
        /// Returns true if MarketingEventUpdateRequestParams instances are equal
        /// </summary>
        /// <param name="input">Instance of MarketingEventUpdateRequestParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarketingEventUpdateRequestParams input)
        {
            if (input == null)
            {
                return false;
