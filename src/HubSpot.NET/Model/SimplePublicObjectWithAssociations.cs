...
namespace HubSpot.NET.Model
{
    ...
    public partial class SimplePublicObjectWithAssociations : IEquatable<SimplePublicObjectWithAssociations>, IValidatableObject
    {
        /// <summary>
        ...
        public SimplePublicObjectWithAssociations(string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), Dictionary<string, List<ValueWithTimestamp>> propertiesWithHistory = default(Dictionary<string, List<ValueWithTimestamp>>), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset), bool archived = default(bool), DateTimeOffset archivedAt = default(DateTimeOffset), Dictionary<string, CollectionResponseAssociatedId> associations = default(Dictionary<string, CollectionResponseAssociatedId>))
        {
        ...
        {
            return this.Equals(input as SimplePublicObjectWithAssociations);
        }

        /// <summary>
        /// Returns true if SimplePublicObjectWithAssociations instances are equal
        /// </summary>
        /// <param name="input">Instance of SimplePublicObjectWithAssociations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimplePublicObjectWithAssociations input)
        {
            if (input == null)
            {
                return false;
