...
namespace HubSpot.NET.Model
{
    ...
    public partial class BatchResponseSimplePublicObject : IEquatable<BatchResponseSimplePublicObject>, IValidatableObject
    {
        ...
        public BatchResponseSimplePublicObject(StatusEnum status = default(StatusEnum), List<SimplePublicObject> results = default(List<SimplePublicObject>), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
