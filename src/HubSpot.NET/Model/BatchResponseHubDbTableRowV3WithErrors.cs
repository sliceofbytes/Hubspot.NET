...
namespace HubSpot.NET.Model
{
    ...
    public partial class BatchResponseHubDbTableRowV3WithErrors : IEquatable<BatchResponseHubDbTableRowV3WithErrors>, IValidatableObject
    {
        ...
        public BatchResponseHubDbTableRowV3WithErrors(StatusEnum status = default(StatusEnum), List<HubDbTableRowV3> results = default(List<HubDbTableRowV3>), int numErrors = default(int), List<HubdbStandardError> errors = default(List<HubdbStandardError>), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
        ...
        public List<HubdbStandardError> Errors { get; set; }
