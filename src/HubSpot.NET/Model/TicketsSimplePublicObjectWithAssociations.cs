...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TicketsSimplePublicObjectWithAssociations")]
    public partial class TicketsSimplePublicObjectWithAssociations : IEquatable<TicketsSimplePublicObjectWithAssociations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TicketsSimplePublicObjectWithAssociations" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TicketsSimplePublicObjectWithAssociations() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TicketsSimplePublicObjectWithAssociations" /> class.
        /// </summary>
        ...
        public TicketsSimplePublicObjectWithAssociations(string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), Dictionary<string, List<ValueWithTimestamp>> propertiesWithHistory = default(Dictionary<string, List<ValueWithTimestamp>>), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset), bool archived = default(bool), DateTimeOffset archivedAt = default(DateTimeOffset), Dictionary<string, TicketsCollectionResponseAssociatedId> associations = default(Dictionary<string, TicketsCollectionResponseAssociatedId>))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for TicketsSimplePublicObjectWithAssociations and cannot be null");
            }
            this.Id = id;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for TicketsSimplePublicObjectWithAssociations and cannot be null");
            }
        ...
        public Dictionary<string, TicketsCollectionResponseAssociatedId> Associations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TicketsSimplePublicObjectWithAssociations {\n");
        ...
        {
            return this.Equals(input as TicketsSimplePublicObjectWithAssociations);
        }

        /// <summary>
        /// Returns true if TicketsSimplePublicObjectWithAssociations instances are equal
        /// </summary>
        /// <param name="input">Instance of TicketsSimplePublicObjectWithAssociations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TicketsSimplePublicObjectWithAssociations input)
        {
            if (input == null)
            {
                return false;
