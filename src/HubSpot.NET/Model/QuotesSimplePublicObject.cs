...
{
    /// <summary>
    /// QuotesSimplePublicObject
    /// </summary>
    [DataContract(Name = "QuotesSimplePublicObject")]
    public partial class QuotesSimplePublicObject : IEquatable<QuotesSimplePublicObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuotesSimplePublicObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QuotesSimplePublicObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QuotesSimplePublicObject" /> class.
        /// </summary>
        ...
        public QuotesSimplePublicObject(string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), Dictionary<string, List<ValueWithTimestamp>> propertiesWithHistory = default(Dictionary<string, List<ValueWithTimestamp>>), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset), bool archived = default(bool), DateTimeOffset archivedAt = default(DateTimeOffset))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for QuotesSimplePublicObject and cannot be null");
            }
            this.Id = id;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for QuotesSimplePublicObject and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QuotesSimplePublicObject {\n");
        ...
        {
            return this.Equals(input as QuotesSimplePublicObject);
        }

        /// <summary>
        /// Returns true if QuotesSimplePublicObject instances are equal
        /// </summary>
        /// <param name="input">Instance of QuotesSimplePublicObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuotesSimplePublicObject input)
        {
            if (input == null)
            {
                return false;
