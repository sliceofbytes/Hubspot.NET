...
namespace HubSpot.NET.Model
{
    ...
    /// PropertyUpdate
    /// </summary>
    [DataContract(Name = "PropertyUpdate")]
    public partial class PropertyUpdate : IEquatable<PropertyUpdate>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyUpdate" /> class.
        /// </summary>
        /// <param name="label">A human-readable property label that will be shown in HubSpot..</param>
        /// <param name="type">The data type of the property..</param>
        /// <param name="fieldType">Controls how the property appears in HubSpot..</param>
        /// <param name="groupName">The name of the property group the property belongs to..</param>
        /// <param name="description">A description of the property that will be shown as help text in HubSpot..</param>
        /// <param name="options">A list of valid options for the property..</param>
        ...
        public PropertyUpdate(string label = default(string), TypeEnum? type = default(TypeEnum?), FieldTypeEnum? fieldType = default(FieldTypeEnum?), string groupName = default(string), string description = default(string), List<PropertiesOptionInput> options = default(List<PropertiesOptionInput>), int displayOrder = default(int), bool hidden = default(bool), bool formField = default(bool))
        {
            this.Label = label;
            this.Type = type;
        ...
        /// </summary>
        /// <value>A list of valid options for the property.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertyUpdate {\n");
        ...
        {
            return this.Equals(input as PropertyUpdate);
        }

        /// <summary>
        /// Returns true if PropertyUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertyUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertyUpdate input)
        {
            if (input == null)
            {
                return false;
