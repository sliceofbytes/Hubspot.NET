...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchResponseBlogAuthor")]
    public partial class BatchResponseBlogAuthor : IEquatable<BatchResponseBlogAuthor>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponseBlogAuthor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchResponseBlogAuthor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponseBlogAuthor" /> class.
        /// </summary>
        ...
        public BatchResponseBlogAuthor(StatusEnum status = default(StatusEnum), List<BlogAuthor> results = default(List<BlogAuthor>), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null) {
                throw new ArgumentNullException("results is a required property for BatchResponseBlogAuthor and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchResponseBlogAuthor {\n");
        ...
        {
            return this.Equals(input as BatchResponseBlogAuthor);
        }

        /// <summary>
        /// Returns true if BatchResponseBlogAuthor instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchResponseBlogAuthor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchResponseBlogAuthor input)
        {
            if (input == null)
            {
                return false;
