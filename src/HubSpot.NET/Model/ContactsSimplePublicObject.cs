...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ContactsSimplePublicObject")]
    public partial class ContactsSimplePublicObject : IEquatable<ContactsSimplePublicObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactsSimplePublicObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContactsSimplePublicObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactsSimplePublicObject" /> class.
        /// </summary>
        ...
        public ContactsSimplePublicObject(string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), Dictionary<string, List<ValueWithTimestamp>> propertiesWithHistory = default(Dictionary<string, List<ValueWithTimestamp>>), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset), bool archived = default(bool), DateTimeOffset archivedAt = default(DateTimeOffset))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for ContactsSimplePublicObject and cannot be null");
            }
            this.Id = id;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for ContactsSimplePublicObject and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactsSimplePublicObject {\n");
        ...
        {
            return this.Equals(input as ContactsSimplePublicObject);
        }

        /// <summary>
        /// Returns true if ContactsSimplePublicObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactsSimplePublicObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactsSimplePublicObject input)
        {
            if (input == null)
            {
                return false;
