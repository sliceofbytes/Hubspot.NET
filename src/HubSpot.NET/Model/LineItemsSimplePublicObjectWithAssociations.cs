...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LineItemsSimplePublicObjectWithAssociations")]
    public partial class LineItemsSimplePublicObjectWithAssociations : IEquatable<LineItemsSimplePublicObjectWithAssociations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LineItemsSimplePublicObjectWithAssociations" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LineItemsSimplePublicObjectWithAssociations() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LineItemsSimplePublicObjectWithAssociations" /> class.
        /// </summary>
        ...
        public LineItemsSimplePublicObjectWithAssociations(string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), Dictionary<string, List<ValueWithTimestamp>> propertiesWithHistory = default(Dictionary<string, List<ValueWithTimestamp>>), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset), bool archived = default(bool), DateTimeOffset archivedAt = default(DateTimeOffset), Dictionary<string, LineItemsCollectionResponseAssociatedId> associations = default(Dictionary<string, LineItemsCollectionResponseAssociatedId>))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for LineItemsSimplePublicObjectWithAssociations and cannot be null");
            }
            this.Id = id;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for LineItemsSimplePublicObjectWithAssociations and cannot be null");
            }
        ...
        public Dictionary<string, LineItemsCollectionResponseAssociatedId> Associations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LineItemsSimplePublicObjectWithAssociations {\n");
        ...
        {
            return this.Equals(input as LineItemsSimplePublicObjectWithAssociations);
        }

        /// <summary>
        /// Returns true if LineItemsSimplePublicObjectWithAssociations instances are equal
        /// </summary>
        /// <param name="input">Instance of LineItemsSimplePublicObjectWithAssociations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LineItemsSimplePublicObjectWithAssociations input)
        {
            if (input == null)
            {
                return false;
