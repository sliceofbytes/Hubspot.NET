...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CompaniesSimplePublicObject")]
    public partial class CompaniesSimplePublicObject : IEquatable<CompaniesSimplePublicObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompaniesSimplePublicObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CompaniesSimplePublicObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CompaniesSimplePublicObject" /> class.
        /// </summary>
        ...
        public CompaniesSimplePublicObject(string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), Dictionary<string, List<ValueWithTimestamp>> propertiesWithHistory = default(Dictionary<string, List<ValueWithTimestamp>>), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset), bool archived = default(bool), DateTimeOffset archivedAt = default(DateTimeOffset))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for CompaniesSimplePublicObject and cannot be null");
            }
            this.Id = id;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for CompaniesSimplePublicObject and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompaniesSimplePublicObject {\n");
        ...
        {
            return this.Equals(input as CompaniesSimplePublicObject);
        }

        /// <summary>
        /// Returns true if CompaniesSimplePublicObject instances are equal
        /// </summary>
        /// <param name="input">Instance of CompaniesSimplePublicObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompaniesSimplePublicObject input)
        {
            if (input == null)
            {
                return false;
