...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MarketingEventPublicDefaultResponse")]
    public partial class MarketingEventPublicDefaultResponse : IEquatable<MarketingEventPublicDefaultResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketingEventPublicDefaultResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MarketingEventPublicDefaultResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketingEventPublicDefaultResponse" /> class.
        /// </summary>
        ...
        public MarketingEventPublicDefaultResponse(string eventName = default(string), string eventType = default(string), DateTimeOffset startDateTime = default(DateTimeOffset), DateTimeOffset endDateTime = default(DateTimeOffset), string eventOrganizer = default(string), string eventDescription = default(string), string eventUrl = default(string), bool eventCancelled = default(bool), List<PropertyValue> customProperties = default(List<PropertyValue>), string id = default(string), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset))
        {
            // to ensure "eventName" is required (not null)
            if (eventName == null) {
                throw new ArgumentNullException("eventName is a required property for MarketingEventPublicDefaultResponse and cannot be null");
            }
            this.EventName = eventName;
            // to ensure "eventOrganizer" is required (not null)
            if (eventOrganizer == null) {
                throw new ArgumentNullException("eventOrganizer is a required property for MarketingEventPublicDefaultResponse and cannot be null");
            }
            this.EventOrganizer = eventOrganizer;
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for MarketingEventPublicDefaultResponse and cannot be null");
            }
            this.Id = id;
        ...
        {
            return this.Equals(input as MarketingEventPublicDefaultResponse);
        }

        /// <summary>
        /// Returns true if MarketingEventPublicDefaultResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MarketingEventPublicDefaultResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarketingEventPublicDefaultResponse input)
        {
            if (input == null)
            {
                return false;
