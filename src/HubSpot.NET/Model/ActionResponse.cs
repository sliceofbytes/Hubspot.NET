...
namespace HubSpot.NET.Model
{
    ...
    /// ActionResponse
    /// </summary>
    [DataContract(Name = "ActionResponse")]
    public partial class ActionResponse : IEquatable<ActionResponse>, IValidatableObject
    {
        ...
        public ActionResponse(StatusEnum status = default(StatusEnum), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
