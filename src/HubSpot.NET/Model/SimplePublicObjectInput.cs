...
namespace HubSpot.NET.Model
{
    ...
    public partial class SimplePublicObjectInput : IEquatable<SimplePublicObjectInput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SimplePublicObjectInput);
        }

        /// <summary>
        /// Returns true if SimplePublicObjectInput instances are equal
        /// </summary>
        /// <param name="input">Instance of SimplePublicObjectInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimplePublicObjectInput input)
        {
            if (input == null)
            {
                return false;
