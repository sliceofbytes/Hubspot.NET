...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BlogAuthor")]
    public partial class BlogAuthor : IEquatable<BlogAuthor>, IValidatableObject
    {
        /// <summary>
        /// The explicitly defined ISO 639 language code of the blog author.
        /// </summary>
        /// <value>The explicitly defined ISO 639 language code of the blog author.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BlogAuthor" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="BlogAuthor" /> class.
        /// </summary>
        /// <param name="id">The unique ID of the Blog Author. (required).</param>
        /// <param name="fullName">fullName (required).</param>
        /// <param name="email">Email address of the Blog Author. (required).</param>
        /// <param name="slug">slug (required).</param>
        /// <param name="language">The explicitly defined ISO 639 language code of the blog author. (required).</param>
        /// <param name="translatedFromId">ID of the primary blog author this object was translated from. (required).</param>
        /// <param name="name">name (required).</param>
        /// <param name="displayName">The full name of the Blog Author to be displayed. (required).</param>
        /// <param name="bio">A short biography of the blog author. (required).</param>
        /// <param name="website">URL to the website of the Blog Author. (required).</param>
        /// <param name="twitter">URL or username of the Twitter account associated with the Blog Author. This will be normalized into the Twitter url for said user. (required).</param>
        /// <param name="facebook">URL to the Blog Author&#39;s Facebook page. (required).</param>
        /// <param name="linkedin">URL to the blog author&#39;s LinkedIn page. (required).</param>
        /// <param name="avatar">URL to the blog author&#39;s avatar, if supplying a custom one. (required).</param>
        /// <param name="deletedAt">The timestamp (ISO8601 format) when this Blog Author was deleted. (required).</param>
        /// <param name="createdAt">The timestamp (ISO8601 format) when this Blog Author was created. (required).</param>
        /// <param name="updatedAt">The timestamp (ISO8601 format) when this Blog Author was last updated. (required).</param>
        public BlogAuthor(string id = default(string), string fullName = default(string), string email = default(string), string slug = default(string), LanguageEnum language = default(LanguageEnum), long translatedFromId = default(long), string name = default(string), string displayName = default(string), string bio = default(string), string website = default(string), string twitter = default(string), string facebook = default(string), string linkedin = default(string), string avatar = default(string), DateTimeOffset deletedAt = default(DateTimeOffset), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for BlogAuthor and cannot be null");
            }
            this.Id = id;
            // to ensure "fullName" is required (not null)
            if (fullName == null) {
                throw new ArgumentNullException("fullName is a required property for BlogAuthor and cannot be null");
            }
            this.FullName = fullName;
            // to ensure "email" is required (not null)
            if (email == null) {
                throw new ArgumentNullException("email is a required property for BlogAuthor and cannot be null");
            }
            this.Email = email;
            // to ensure "slug" is required (not null)
            if (slug == null) {
                throw new ArgumentNullException("slug is a required property for BlogAuthor and cannot be null");
            }
            this.Slug = slug;
            ...
            if (name == null) {
                throw new ArgumentNullException("name is a required property for BlogAuthor and cannot be null");
            }
            this.Name = name;
            // to ensure "displayName" is required (not null)
            if (displayName == null) {
                throw new ArgumentNullException("displayName is a required property for BlogAuthor and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "bio" is required (not null)
            if (bio == null) {
                throw new ArgumentNullException("bio is a required property for BlogAuthor and cannot be null");
            }
            this.Bio = bio;
            // to ensure "website" is required (not null)
            if (website == null) {
                throw new ArgumentNullException("website is a required property for BlogAuthor and cannot be null");
            }
            this.Website = website;
            // to ensure "twitter" is required (not null)
            if (twitter == null) {
                throw new ArgumentNullException("twitter is a required property for BlogAuthor and cannot be null");
            }
            this.Twitter = twitter;
            // to ensure "facebook" is required (not null)
            if (facebook == null) {
                throw new ArgumentNullException("facebook is a required property for BlogAuthor and cannot be null");
            }
            this.Facebook = facebook;
            // to ensure "linkedin" is required (not null)
            if (linkedin == null) {
                throw new ArgumentNullException("linkedin is a required property for BlogAuthor and cannot be null");
            }
            this.Linkedin = linkedin;
            // to ensure "avatar" is required (not null)
            if (avatar == null) {
                throw new ArgumentNullException("avatar is a required property for BlogAuthor and cannot be null");
            }
            this.Avatar = avatar;
        ...
        /// </summary>
        /// <value>The unique ID of the Blog Author.</value>
        ...
        /// </summary>
        /// <value>Email address of the Blog Author.</value>
        ...
        /// </summary>
        /// <value>ID of the primary blog author this object was translated from.</value>
        ...
        /// </summary>
        /// <value>The full name of the Blog Author to be displayed.</value>
        ...
        /// </summary>
        /// <value>A short biography of the blog author.</value>
        ...
        /// </summary>
        /// <value>URL to the website of the Blog Author.</value>
        ...
        /// </summary>
        /// <value>URL or username of the Twitter account associated with the Blog Author. This will be normalized into the Twitter url for said user.</value>
        ...
        /// </summary>
        /// <value>URL to the Blog Author&#39;s Facebook page.</value>
        [DataMember(Name = "facebook", IsRequired = true, EmitDefaultValue = false)]
        public string Facebook { get; set; }

        /// <summary>
        /// URL to the blog author&#39;s LinkedIn page.
        /// </summary>
        /// <value>URL to the blog author&#39;s LinkedIn page.</value>
        [DataMember(Name = "linkedin", IsRequired = true, EmitDefaultValue = false)]
        public string Linkedin { get; set; }

        /// <summary>
        /// URL to the blog author&#39;s avatar, if supplying a custom one.
        /// </summary>
        /// <value>URL to the blog author&#39;s avatar, if supplying a custom one.</value>
        ...
        /// </summary>
        /// <value>The timestamp (ISO8601 format) when this Blog Author was deleted.</value>
        ...
        /// </summary>
        /// <value>The timestamp (ISO8601 format) when this Blog Author was created.</value>
        ...
        /// </summary>
        /// <value>The timestamp (ISO8601 format) when this Blog Author was last updated.</value>
        ...
        {
            return this.Equals(input as BlogAuthor);
        }

        /// <summary>
        /// Returns true if BlogAuthor instances are equal
        /// </summary>
        /// <param name="input">Instance of BlogAuthor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlogAuthor input)
        {
            if (input == null)
            {
                return false;
