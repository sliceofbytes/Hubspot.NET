...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CompaniesSimplePublicObjectWithAssociations")]
    public partial class CompaniesSimplePublicObjectWithAssociations : IEquatable<CompaniesSimplePublicObjectWithAssociations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompaniesSimplePublicObjectWithAssociations" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CompaniesSimplePublicObjectWithAssociations() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CompaniesSimplePublicObjectWithAssociations" /> class.
        /// </summary>
        ...
        public CompaniesSimplePublicObjectWithAssociations(string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), Dictionary<string, List<ValueWithTimestamp>> propertiesWithHistory = default(Dictionary<string, List<ValueWithTimestamp>>), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset), bool archived = default(bool), DateTimeOffset archivedAt = default(DateTimeOffset), Dictionary<string, CompaniesCollectionResponseAssociatedId> associations = default(Dictionary<string, CompaniesCollectionResponseAssociatedId>))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for CompaniesSimplePublicObjectWithAssociations and cannot be null");
            }
            this.Id = id;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for CompaniesSimplePublicObjectWithAssociations and cannot be null");
            }
        ...
        public Dictionary<string, CompaniesCollectionResponseAssociatedId> Associations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompaniesSimplePublicObjectWithAssociations {\n");
        ...
        {
            return this.Equals(input as CompaniesSimplePublicObjectWithAssociations);
        }

        /// <summary>
        /// Returns true if CompaniesSimplePublicObjectWithAssociations instances are equal
        /// </summary>
        /// <param name="input">Instance of CompaniesSimplePublicObjectWithAssociations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompaniesSimplePublicObjectWithAssociations input)
        {
            if (input == null)
            {
                return false;
