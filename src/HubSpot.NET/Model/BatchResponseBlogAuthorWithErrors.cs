...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchResponseBlogAuthorWithErrors")]
    public partial class BatchResponseBlogAuthorWithErrors : IEquatable<BatchResponseBlogAuthorWithErrors>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponseBlogAuthorWithErrors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchResponseBlogAuthorWithErrors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponseBlogAuthorWithErrors" /> class.
        /// </summary>
        ...
        /// <param name="errors">Errors in batch operation..</param>
        ...
        public BatchResponseBlogAuthorWithErrors(StatusEnum status = default(StatusEnum), List<BlogAuthor> results = default(List<BlogAuthor>), int numErrors = default(int), List<AuthorsStandardError> errors = default(List<AuthorsStandardError>), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null) {
                throw new ArgumentNullException("results is a required property for BatchResponseBlogAuthorWithErrors and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Errors in batch operation.</value>
        [DataMember(Name = "errors", EmitDefaultValue = false)]
        public List<AuthorsStandardError> Errors { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchResponseBlogAuthorWithErrors {\n");
        ...
        {
            return this.Equals(input as BatchResponseBlogAuthorWithErrors);
        }

        /// <summary>
        /// Returns true if BatchResponseBlogAuthorWithErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchResponseBlogAuthorWithErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchResponseBlogAuthorWithErrors input)
        {
            if (input == null)
            {
                return false;
