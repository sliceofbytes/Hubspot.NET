...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FeedbackSubmissionsSimplePublicObjectWithAssociations")]
    public partial class FeedbackSubmissionsSimplePublicObjectWithAssociations : IEquatable<FeedbackSubmissionsSimplePublicObjectWithAssociations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeedbackSubmissionsSimplePublicObjectWithAssociations" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FeedbackSubmissionsSimplePublicObjectWithAssociations() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FeedbackSubmissionsSimplePublicObjectWithAssociations" /> class.
        /// </summary>
        ...
        public FeedbackSubmissionsSimplePublicObjectWithAssociations(string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), Dictionary<string, List<ValueWithTimestamp>> propertiesWithHistory = default(Dictionary<string, List<ValueWithTimestamp>>), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset), bool archived = default(bool), DateTimeOffset archivedAt = default(DateTimeOffset), Dictionary<string, FeedbackSubmissionsCollectionResponseAssociatedId> associations = default(Dictionary<string, FeedbackSubmissionsCollectionResponseAssociatedId>))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for FeedbackSubmissionsSimplePublicObjectWithAssociations and cannot be null");
            }
            this.Id = id;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for FeedbackSubmissionsSimplePublicObjectWithAssociations and cannot be null");
            }
        ...
        public Dictionary<string, FeedbackSubmissionsCollectionResponseAssociatedId> Associations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FeedbackSubmissionsSimplePublicObjectWithAssociations {\n");
        ...
        {
            return this.Equals(input as FeedbackSubmissionsSimplePublicObjectWithAssociations);
        }

        /// <summary>
        /// Returns true if FeedbackSubmissionsSimplePublicObjectWithAssociations instances are equal
        /// </summary>
        /// <param name="input">Instance of FeedbackSubmissionsSimplePublicObjectWithAssociations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeedbackSubmissionsSimplePublicObjectWithAssociations input)
        {
            if (input == null)
            {
                return false;
