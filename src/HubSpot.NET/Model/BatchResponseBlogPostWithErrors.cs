...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchResponseBlogPostWithErrors")]
    public partial class BatchResponseBlogPostWithErrors : IEquatable<BatchResponseBlogPostWithErrors>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponseBlogPostWithErrors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchResponseBlogPostWithErrors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponseBlogPostWithErrors" /> class.
        /// </summary>
        ...
        public BatchResponseBlogPostWithErrors(StatusEnum status = default(StatusEnum), List<BlogPost> results = default(List<BlogPost>), int numErrors = default(int), List<BlogPostsStandardError> errors = default(List<BlogPostsStandardError>), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null) {
                throw new ArgumentNullException("results is a required property for BatchResponseBlogPostWithErrors and cannot be null");
            }
        ...
        public List<BlogPostsStandardError> Errors { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchResponseBlogPostWithErrors {\n");
        ...
        {
            return this.Equals(input as BatchResponseBlogPostWithErrors);
        }

        /// <summary>
        /// Returns true if BatchResponseBlogPostWithErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchResponseBlogPostWithErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchResponseBlogPostWithErrors input)
        {
            if (input == null)
            {
                return false;
