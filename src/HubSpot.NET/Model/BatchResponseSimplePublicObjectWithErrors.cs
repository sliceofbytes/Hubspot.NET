...
namespace HubSpot.NET.Model
{
    ...
    public partial class BatchResponseSimplePublicObjectWithErrors : IEquatable<BatchResponseSimplePublicObjectWithErrors>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        {
            return this.Equals(input as BatchResponseSimplePublicObjectWithErrors);
        }

        /// <summary>
        /// Returns true if BatchResponseSimplePublicObjectWithErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchResponseSimplePublicObjectWithErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchResponseSimplePublicObjectWithErrors input)
        {
            if (input == null)
            {
                return false;
