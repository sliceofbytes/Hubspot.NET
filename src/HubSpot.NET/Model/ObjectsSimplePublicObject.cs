...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ObjectsSimplePublicObject")]
    public partial class ObjectsSimplePublicObject : IEquatable<ObjectsSimplePublicObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectsSimplePublicObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ObjectsSimplePublicObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectsSimplePublicObject" /> class.
        /// </summary>
        ...
        public ObjectsSimplePublicObject(string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), Dictionary<string, List<ValueWithTimestamp>> propertiesWithHistory = default(Dictionary<string, List<ValueWithTimestamp>>), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset), bool archived = default(bool), DateTimeOffset archivedAt = default(DateTimeOffset))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for ObjectsSimplePublicObject and cannot be null");
            }
            this.Id = id;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for ObjectsSimplePublicObject and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ObjectsSimplePublicObject {\n");
        ...
        {
            return this.Equals(input as ObjectsSimplePublicObject);
        }

        /// <summary>
        /// Returns true if ObjectsSimplePublicObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ObjectsSimplePublicObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectsSimplePublicObject input)
        {
            if (input == null)
            {
                return false;
