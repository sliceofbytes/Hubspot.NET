...
{
    /// <summary>
    /// TimelineErrorCategory
    /// </summary>
    [DataContract(Name = "TimelineErrorCategory")]
    public partial class TimelineErrorCategory : IEquatable<TimelineErrorCategory>, IValidatableObject
    {
        /// <summary>
        /// Defines HttpStatus
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimelineErrorCategory" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TimelineErrorCategory() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TimelineErrorCategory" /> class.
        /// </summary>
        /// <param name="httpStatus">httpStatus (required).</param>
        /// <param name="name">name (required).</param>
        public TimelineErrorCategory(HttpStatusEnum httpStatus = default(HttpStatusEnum), string name = default(string))
        {
            this.HttpStatus = httpStatus;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for TimelineErrorCategory and cannot be null");
            }
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TimelineErrorCategory {\n");
        ...
        {
            return this.Equals(input as TimelineErrorCategory);
        }

        /// <summary>
        /// Returns true if TimelineErrorCategory instances are equal
        /// </summary>
        /// <param name="input">Instance of TimelineErrorCategory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimelineErrorCategory input)
        {
            if (input == null)
            {
                return false;
