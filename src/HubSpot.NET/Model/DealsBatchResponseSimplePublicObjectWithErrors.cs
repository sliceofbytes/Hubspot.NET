...
{
    /// <summary>
    /// DealsBatchResponseSimplePublicObjectWithErrors
    /// </summary>
    [DataContract(Name = "DealsBatchResponseSimplePublicObjectWithErrors")]
    public partial class DealsBatchResponseSimplePublicObjectWithErrors : IEquatable<DealsBatchResponseSimplePublicObjectWithErrors>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsBatchResponseSimplePublicObjectWithErrors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DealsBatchResponseSimplePublicObjectWithErrors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsBatchResponseSimplePublicObjectWithErrors" /> class.
        /// </summary>
        ...
        public DealsBatchResponseSimplePublicObjectWithErrors(StatusEnum status = default(StatusEnum), List<DealsSimplePublicObject> results = default(List<DealsSimplePublicObject>), int numErrors = default(int), List<StandardError> errors = default(List<StandardError>), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null) {
                throw new ArgumentNullException("results is a required property for DealsBatchResponseSimplePublicObjectWithErrors and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DealsBatchResponseSimplePublicObjectWithErrors {\n");
        ...
        {
            return this.Equals(input as DealsBatchResponseSimplePublicObjectWithErrors);
        }

        /// <summary>
        /// Returns true if DealsBatchResponseSimplePublicObjectWithErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of DealsBatchResponseSimplePublicObjectWithErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DealsBatchResponseSimplePublicObjectWithErrors input)
        {
            if (input == null)
            {
                return false;
