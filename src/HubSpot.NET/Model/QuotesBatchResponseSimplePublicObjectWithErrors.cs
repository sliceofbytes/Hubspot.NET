...
{
    /// <summary>
    /// QuotesBatchResponseSimplePublicObjectWithErrors
    /// </summary>
    [DataContract(Name = "QuotesBatchResponseSimplePublicObjectWithErrors")]
    public partial class QuotesBatchResponseSimplePublicObjectWithErrors : IEquatable<QuotesBatchResponseSimplePublicObjectWithErrors>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QuotesBatchResponseSimplePublicObjectWithErrors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QuotesBatchResponseSimplePublicObjectWithErrors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QuotesBatchResponseSimplePublicObjectWithErrors" /> class.
        /// </summary>
        ...
        public QuotesBatchResponseSimplePublicObjectWithErrors(StatusEnum status = default(StatusEnum), List<QuotesSimplePublicObject> results = default(List<QuotesSimplePublicObject>), int numErrors = default(int), List<StandardError> errors = default(List<StandardError>), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null) {
                throw new ArgumentNullException("results is a required property for QuotesBatchResponseSimplePublicObjectWithErrors and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QuotesBatchResponseSimplePublicObjectWithErrors {\n");
        ...
        {
            return this.Equals(input as QuotesBatchResponseSimplePublicObjectWithErrors);
        }

        /// <summary>
        /// Returns true if QuotesBatchResponseSimplePublicObjectWithErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of QuotesBatchResponseSimplePublicObjectWithErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuotesBatchResponseSimplePublicObjectWithErrors input)
        {
            if (input == null)
            {
                return false;
