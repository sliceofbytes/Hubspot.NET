...
{
    /// <summary>
    /// ObjectsBatchResponseSimplePublicObjectWithErrors
    /// </summary>
    [DataContract(Name = "ObjectsBatchResponseSimplePublicObjectWithErrors")]
    public partial class ObjectsBatchResponseSimplePublicObjectWithErrors : IEquatable<ObjectsBatchResponseSimplePublicObjectWithErrors>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectsBatchResponseSimplePublicObjectWithErrors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ObjectsBatchResponseSimplePublicObjectWithErrors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectsBatchResponseSimplePublicObjectWithErrors" /> class.
        /// </summary>
        ...
        public ObjectsBatchResponseSimplePublicObjectWithErrors(StatusEnum status = default(StatusEnum), List<ObjectsSimplePublicObject> results = default(List<ObjectsSimplePublicObject>), int numErrors = default(int), List<StandardError> errors = default(List<StandardError>), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null) {
                throw new ArgumentNullException("results is a required property for ObjectsBatchResponseSimplePublicObjectWithErrors and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ObjectsBatchResponseSimplePublicObjectWithErrors {\n");
        ...
        {
            return this.Equals(input as ObjectsBatchResponseSimplePublicObjectWithErrors);
        }

        /// <summary>
        /// Returns true if ObjectsBatchResponseSimplePublicObjectWithErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of ObjectsBatchResponseSimplePublicObjectWithErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectsBatchResponseSimplePublicObjectWithErrors input)
        {
            if (input == null)
            {
                return false;
