...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LineItemsSimplePublicObject")]
    public partial class LineItemsSimplePublicObject : IEquatable<LineItemsSimplePublicObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LineItemsSimplePublicObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LineItemsSimplePublicObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LineItemsSimplePublicObject" /> class.
        /// </summary>
        ...
        public LineItemsSimplePublicObject(string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), Dictionary<string, List<ValueWithTimestamp>> propertiesWithHistory = default(Dictionary<string, List<ValueWithTimestamp>>), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset), bool archived = default(bool), DateTimeOffset archivedAt = default(DateTimeOffset))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for LineItemsSimplePublicObject and cannot be null");
            }
            this.Id = id;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for LineItemsSimplePublicObject and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LineItemsSimplePublicObject {\n");
        ...
        {
            return this.Equals(input as LineItemsSimplePublicObject);
        }

        /// <summary>
        /// Returns true if LineItemsSimplePublicObject instances are equal
        /// </summary>
        /// <param name="input">Instance of LineItemsSimplePublicObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LineItemsSimplePublicObject input)
        {
            if (input == null)
            {
                return false;
