...
{
    /// <summary>
    /// ContactsBatchResponseSimplePublicObjectWithErrors
    /// </summary>
    [DataContract(Name = "ContactsBatchResponseSimplePublicObjectWithErrors")]
    public partial class ContactsBatchResponseSimplePublicObjectWithErrors : IEquatable<ContactsBatchResponseSimplePublicObjectWithErrors>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactsBatchResponseSimplePublicObjectWithErrors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContactsBatchResponseSimplePublicObjectWithErrors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactsBatchResponseSimplePublicObjectWithErrors" /> class.
        /// </summary>
        ...
        public ContactsBatchResponseSimplePublicObjectWithErrors(StatusEnum status = default(StatusEnum), List<ContactsSimplePublicObject> results = default(List<ContactsSimplePublicObject>), int numErrors = default(int), List<StandardError> errors = default(List<StandardError>), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null) {
                throw new ArgumentNullException("results is a required property for ContactsBatchResponseSimplePublicObjectWithErrors and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactsBatchResponseSimplePublicObjectWithErrors {\n");
        ...
        {
            return this.Equals(input as ContactsBatchResponseSimplePublicObjectWithErrors);
        }

        /// <summary>
        /// Returns true if ContactsBatchResponseSimplePublicObjectWithErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactsBatchResponseSimplePublicObjectWithErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactsBatchResponseSimplePublicObjectWithErrors input)
        {
            if (input == null)
            {
                return false;
