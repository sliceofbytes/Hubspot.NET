...
namespace HubSpot.NET.Model
{
    ...
    public partial class TimelineEvent : IEquatable<TimelineEvent>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="id">Identifier for the event. This is optional, and we recommend you do not pass this in. We will create one for you if you omit this. You can also use &#x60;{{uuid}}&#x60; anywhere in the ID to generate a unique string, guaranteeing uniqueness. (required).</param>
        public TimelineEvent(string eventTemplateId = default(string), string email = default(string), string objectId = default(string), string utk = default(string), string domain = default(string), DateTimeOffset timestamp = default(DateTimeOffset), Dictionary<string, string> tokens = default(Dictionary<string, string>), Object extraData = default(Object), TimelineEventIFrame timelineIFrame = default(TimelineEventIFrame), string id = default(string))
        {
            // to ensure "eventTemplateId" is required (not null)
            if (eventTemplateId == null) {
                throw new ArgumentNullException("eventTemplateId is a required property for TimelineEvent and cannot be null");
            }
            this.EventTemplateId = eventTemplateId;
            // to ensure "tokens" is required (not null)
            if (tokens == null) {
                throw new ArgumentNullException("tokens is a required property for TimelineEvent and cannot be null");
            }
            this.Tokens = tokens;
        ...
        /// </summary>
        /// <value>Identifier for the event. This is optional, and we recommend you do not pass this in. We will create one for you if you omit this. You can also use &#x60;{{uuid}}&#x60; anywhere in the ID to generate a unique string, guaranteeing uniqueness.</value>
        ...
        {
            return this.Equals(input as TimelineEvent);
        }

        /// <summary>
        /// Returns true if TimelineEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of TimelineEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimelineEvent input)
        {
            if (input == null)
            {
                return false;
