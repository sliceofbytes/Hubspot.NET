...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthorsStandardError")]
    public partial class AuthorsStandardError : IEquatable<AuthorsStandardError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorsStandardError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthorsStandardError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorsStandardError" /> class.
        /// </summary>
        ...
        public AuthorsStandardError(string status = default(string), string id = default(string), Object category = default(Object), Object subCategory = default(Object), string message = default(string), List<ErrorDetail> errors = default(List<ErrorDetail>), Dictionary<string, List<string>> context = default(Dictionary<string, List<string>>), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for AuthorsStandardError and cannot be null");
            }
            this.Status = status;
            // to ensure "category" is required (not null)
            if (category == null) {
                throw new ArgumentNullException("category is a required property for AuthorsStandardError and cannot be null");
            }
            this.Category = category;
            // to ensure "message" is required (not null)
            if (message == null) {
                throw new ArgumentNullException("message is a required property for AuthorsStandardError and cannot be null");
            }
            this.Message = message;
            // to ensure "errors" is required (not null)
            if (errors == null) {
                throw new ArgumentNullException("errors is a required property for AuthorsStandardError and cannot be null");
            }
            this.Errors = errors;
            // to ensure "context" is required (not null)
            if (context == null) {
                throw new ArgumentNullException("context is a required property for AuthorsStandardError and cannot be null");
            }
            this.Context = context;
            // to ensure "links" is required (not null)
            if (links == null) {
                throw new ArgumentNullException("links is a required property for AuthorsStandardError and cannot be null");
            }
            this.Links = links;
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthorsStandardError {\n");
        ...
        {
            return this.Equals(input as AuthorsStandardError);
        }

        /// <summary>
        /// Returns true if AuthorsStandardError instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorsStandardError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorsStandardError input)
        {
            if (input == null)
            {
                return false;
