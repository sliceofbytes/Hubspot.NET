...
{
    /// <summary>
    /// LineItemsBatchResponseSimplePublicObjectWithErrors
    /// </summary>
    [DataContract(Name = "LineItemsBatchResponseSimplePublicObjectWithErrors")]
    public partial class LineItemsBatchResponseSimplePublicObjectWithErrors : IEquatable<LineItemsBatchResponseSimplePublicObjectWithErrors>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LineItemsBatchResponseSimplePublicObjectWithErrors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LineItemsBatchResponseSimplePublicObjectWithErrors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LineItemsBatchResponseSimplePublicObjectWithErrors" /> class.
        /// </summary>
        ...
        public LineItemsBatchResponseSimplePublicObjectWithErrors(StatusEnum status = default(StatusEnum), List<LineItemsSimplePublicObject> results = default(List<LineItemsSimplePublicObject>), int numErrors = default(int), List<StandardError> errors = default(List<StandardError>), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null) {
                throw new ArgumentNullException("results is a required property for LineItemsBatchResponseSimplePublicObjectWithErrors and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LineItemsBatchResponseSimplePublicObjectWithErrors {\n");
        ...
        {
            return this.Equals(input as LineItemsBatchResponseSimplePublicObjectWithErrors);
        }

        /// <summary>
        /// Returns true if LineItemsBatchResponseSimplePublicObjectWithErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of LineItemsBatchResponseSimplePublicObjectWithErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LineItemsBatchResponseSimplePublicObjectWithErrors input)
        {
            if (input == null)
            {
                return false;
