...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DealsSimplePublicObjectWithAssociations")]
    public partial class DealsSimplePublicObjectWithAssociations : IEquatable<DealsSimplePublicObjectWithAssociations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsSimplePublicObjectWithAssociations" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DealsSimplePublicObjectWithAssociations() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsSimplePublicObjectWithAssociations" /> class.
        /// </summary>
        ...
        public DealsSimplePublicObjectWithAssociations(string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), Dictionary<string, List<ValueWithTimestamp>> propertiesWithHistory = default(Dictionary<string, List<ValueWithTimestamp>>), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset), bool archived = default(bool), DateTimeOffset archivedAt = default(DateTimeOffset), Dictionary<string, DealsCollectionResponseAssociatedId> associations = default(Dictionary<string, DealsCollectionResponseAssociatedId>))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for DealsSimplePublicObjectWithAssociations and cannot be null");
            }
            this.Id = id;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for DealsSimplePublicObjectWithAssociations and cannot be null");
            }
        ...
        public Dictionary<string, DealsCollectionResponseAssociatedId> Associations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DealsSimplePublicObjectWithAssociations {\n");
        ...
        {
            return this.Equals(input as DealsSimplePublicObjectWithAssociations);
        }

        /// <summary>
        /// Returns true if DealsSimplePublicObjectWithAssociations instances are equal
        /// </summary>
        /// <param name="input">Instance of DealsSimplePublicObjectWithAssociations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DealsSimplePublicObjectWithAssociations input)
        {
            if (input == null)
            {
                return false;
