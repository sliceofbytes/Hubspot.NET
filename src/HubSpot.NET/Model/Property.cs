...
namespace HubSpot.NET.Model
{
    ...
    public partial class Property : IEquatable<Property>, IValidatableObject
    {
        ...
        /// <param name="createdAt">When the property was created.</param>
        ...
        /// <param name="createdUserId">The internal ID of the user who created the property in HubSpot. This field may not exist if the property was created outside of HubSpot..</param>
        ...
        /// <param name="showCurrencySymbol">Whether the property will display the currency symbol set in the account settings..</param>
        ...
        public Property(DateTimeOffset updatedAt = default(DateTimeOffset), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset archivedAt = default(DateTimeOffset), string name = default(string), string label = default(string), string type = default(string), string fieldType = default(string), string description = default(string), string groupName = default(string), List<SchemasOption> options = default(List<SchemasOption>), string createdUserId = default(string), string updatedUserId = default(string), string referencedObjectType = default(string), int displayOrder = default(int), bool calculated = default(bool), bool externalOptions = default(bool), bool archived = default(bool), bool hasUniqueValue = default(bool), bool hidden = default(bool), bool hubspotDefined = default(bool), bool showCurrencySymbol = default(bool), PropertyModificationMetadata modificationMetadata = default(PropertyModificationMetadata), bool formField = default(bool))
        {
            ...
            if (label == null) {
                throw new ArgumentNullException("label is a required property for Property and cannot be null");
            }
            this.Label = label;
            ...
            if (fieldType == null) {
                throw new ArgumentNullException("fieldType is a required property for Property and cannot be null");
            }
            this.FieldType = fieldType;
            // to ensure "description" is required (not null)
            if (description == null) {
                throw new ArgumentNullException("description is a required property for Property and cannot be null");
            }
            this.Description = description;
            // to ensure "groupName" is required (not null)
            if (groupName == null) {
                throw new ArgumentNullException("groupName is a required property for Property and cannot be null");
            }
            this.GroupName = groupName;
            // to ensure "options" is required (not null)
            if (options == null) {
                throw new ArgumentNullException("options is a required property for Property and cannot be null");
            }
        ...
        /// </summary>
        /// <value>When the property was created</value>
        ...
        public List<SchemasOption> Options { get; set; }
        ...
        /// </summary>
        /// <value>The internal ID of the user who created the property in HubSpot. This field may not exist if the property was created outside of HubSpot.</value>
        ...
        /// </summary>
        /// <value>Whether the property will display the currency symbol set in the account settings.</value>
