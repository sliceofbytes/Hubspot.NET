...
{
    /// <summary>
    /// TicketsBatchResponseSimplePublicObjectWithErrors
    /// </summary>
    [DataContract(Name = "TicketsBatchResponseSimplePublicObjectWithErrors")]
    public partial class TicketsBatchResponseSimplePublicObjectWithErrors : IEquatable<TicketsBatchResponseSimplePublicObjectWithErrors>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TicketsBatchResponseSimplePublicObjectWithErrors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TicketsBatchResponseSimplePublicObjectWithErrors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TicketsBatchResponseSimplePublicObjectWithErrors" /> class.
        /// </summary>
        ...
        public TicketsBatchResponseSimplePublicObjectWithErrors(StatusEnum status = default(StatusEnum), List<TicketsSimplePublicObject> results = default(List<TicketsSimplePublicObject>), int numErrors = default(int), List<StandardError> errors = default(List<StandardError>), DateTimeOffset requestedAt = default(DateTimeOffset), DateTimeOffset startedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null) {
                throw new ArgumentNullException("results is a required property for TicketsBatchResponseSimplePublicObjectWithErrors and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TicketsBatchResponseSimplePublicObjectWithErrors {\n");
        ...
        {
            return this.Equals(input as TicketsBatchResponseSimplePublicObjectWithErrors);
        }

        /// <summary>
        /// Returns true if TicketsBatchResponseSimplePublicObjectWithErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of TicketsBatchResponseSimplePublicObjectWithErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TicketsBatchResponseSimplePublicObjectWithErrors input)
        {
            if (input == null)
            {
                return false;
