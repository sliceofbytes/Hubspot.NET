...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DealsSimplePublicObject")]
    public partial class DealsSimplePublicObject : IEquatable<DealsSimplePublicObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsSimplePublicObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DealsSimplePublicObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsSimplePublicObject" /> class.
        /// </summary>
        ...
        public DealsSimplePublicObject(string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), Dictionary<string, List<ValueWithTimestamp>> propertiesWithHistory = default(Dictionary<string, List<ValueWithTimestamp>>), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset), bool archived = default(bool), DateTimeOffset archivedAt = default(DateTimeOffset))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for DealsSimplePublicObject and cannot be null");
            }
            this.Id = id;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for DealsSimplePublicObject and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DealsSimplePublicObject {\n");
        ...
        {
            return this.Equals(input as DealsSimplePublicObject);
        }

        /// <summary>
        /// Returns true if DealsSimplePublicObject instances are equal
        /// </summary>
        /// <param name="input">Instance of DealsSimplePublicObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DealsSimplePublicObject input)
        {
            if (input == null)
            {
                return false;
