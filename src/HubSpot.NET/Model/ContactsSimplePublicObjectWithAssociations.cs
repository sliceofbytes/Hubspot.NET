...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ContactsSimplePublicObjectWithAssociations")]
    public partial class ContactsSimplePublicObjectWithAssociations : IEquatable<ContactsSimplePublicObjectWithAssociations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactsSimplePublicObjectWithAssociations" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContactsSimplePublicObjectWithAssociations() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactsSimplePublicObjectWithAssociations" /> class.
        /// </summary>
        ...
        public ContactsSimplePublicObjectWithAssociations(string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), Dictionary<string, List<ValueWithTimestamp>> propertiesWithHistory = default(Dictionary<string, List<ValueWithTimestamp>>), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset), bool archived = default(bool), DateTimeOffset archivedAt = default(DateTimeOffset), Dictionary<string, ContactsCollectionResponseAssociatedId> associations = default(Dictionary<string, ContactsCollectionResponseAssociatedId>))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for ContactsSimplePublicObjectWithAssociations and cannot be null");
            }
            this.Id = id;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for ContactsSimplePublicObjectWithAssociations and cannot be null");
            }
        ...
        public Dictionary<string, ContactsCollectionResponseAssociatedId> Associations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactsSimplePublicObjectWithAssociations {\n");
        ...
        {
            return this.Equals(input as ContactsSimplePublicObjectWithAssociations);
        }

        /// <summary>
        /// Returns true if ContactsSimplePublicObjectWithAssociations instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactsSimplePublicObjectWithAssociations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactsSimplePublicObjectWithAssociations input)
        {
            if (input == null)
            {
                return false;
