...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TimelineEventTemplateCreateRequest")]
    public partial class TimelineEventTemplateCreateRequest : IEquatable<TimelineEventTemplateCreateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimelineEventTemplateCreateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TimelineEventTemplateCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TimelineEventTemplateCreateRequest" /> class.
        /// </summary>
        ...
        public TimelineEventTemplateCreateRequest(string name = default(string), string headerTemplate = default(string), string detailTemplate = default(string), List<TimelineEventTemplateToken> tokens = default(List<TimelineEventTemplateToken>), string objectType = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for TimelineEventTemplateCreateRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "tokens" is required (not null)
            if (tokens == null) {
                throw new ArgumentNullException("tokens is a required property for TimelineEventTemplateCreateRequest and cannot be null");
            }
            this.Tokens = tokens;
            // to ensure "objectType" is required (not null)
            if (objectType == null) {
                throw new ArgumentNullException("objectType is a required property for TimelineEventTemplateCreateRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TimelineEventTemplateCreateRequest {\n");
        ...
        {
            return this.Equals(input as TimelineEventTemplateCreateRequest);
        }

        /// <summary>
        /// Returns true if TimelineEventTemplateCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TimelineEventTemplateCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimelineEventTemplateCreateRequest input)
        {
            if (input == null)
            {
                return false;
