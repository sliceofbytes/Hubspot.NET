...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QuotesSimplePublicObjectWithAssociations")]
    public partial class QuotesSimplePublicObjectWithAssociations : IEquatable<QuotesSimplePublicObjectWithAssociations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuotesSimplePublicObjectWithAssociations" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QuotesSimplePublicObjectWithAssociations() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QuotesSimplePublicObjectWithAssociations" /> class.
        /// </summary>
        ...
        public QuotesSimplePublicObjectWithAssociations(string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), Dictionary<string, List<ValueWithTimestamp>> propertiesWithHistory = default(Dictionary<string, List<ValueWithTimestamp>>), DateTimeOffset createdAt = default(DateTimeOffset), DateTimeOffset updatedAt = default(DateTimeOffset), bool archived = default(bool), DateTimeOffset archivedAt = default(DateTimeOffset), Dictionary<string, QuotesCollectionResponseAssociatedId> associations = default(Dictionary<string, QuotesCollectionResponseAssociatedId>))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for QuotesSimplePublicObjectWithAssociations and cannot be null");
            }
            this.Id = id;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for QuotesSimplePublicObjectWithAssociations and cannot be null");
            }
        ...
        public Dictionary<string, QuotesCollectionResponseAssociatedId> Associations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QuotesSimplePublicObjectWithAssociations {\n");
        ...
        {
            return this.Equals(input as QuotesSimplePublicObjectWithAssociations);
        }

        /// <summary>
        /// Returns true if QuotesSimplePublicObjectWithAssociations instances are equal
        /// </summary>
        /// <param name="input">Instance of QuotesSimplePublicObjectWithAssociations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuotesSimplePublicObjectWithAssociations input)
        {
            if (input == null)
            {
                return false;
