...
namespace HubSpot.NET.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SchemasOption")]
    public partial class SchemasOption : IEquatable<SchemasOption>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchemasOption" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SchemasOption() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SchemasOption" /> class.
        /// </summary>
        ...
        public SchemasOption(string label = default(string), string value = default(string), string description = default(string), int displayOrder = default(int), bool hidden = default(bool))
        {
            // to ensure "label" is required (not null)
            if (label == null) {
                throw new ArgumentNullException("label is a required property for SchemasOption and cannot be null");
            }
            this.Label = label;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for SchemasOption and cannot be null");
            }
            this.Value = value;
            this.Hidden = hidden;
        ...
        {
            return this.Equals(input as SchemasOption);
        }

        /// <summary>
        /// Returns true if SchemasOption instances are equal
        /// </summary>
        /// <param name="input">Instance of SchemasOption to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SchemasOption input)
        {
            if (input == null)
            {
                return false;
