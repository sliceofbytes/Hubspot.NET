...
{
    /// <summary>
    /// PropertiesErrorCategory
    /// </summary>
    [DataContract(Name = "PropertiesErrorCategory")]
    public partial class PropertiesErrorCategory : IEquatable<PropertiesErrorCategory>, IValidatableObject
    {
        /// <summary>
        /// Defines HttpStatus
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesErrorCategory" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PropertiesErrorCategory() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertiesErrorCategory" /> class.
        /// </summary>
        /// <param name="httpStatus">httpStatus (required).</param>
        /// <param name="name">name (required).</param>
        public PropertiesErrorCategory(HttpStatusEnum httpStatus = default(HttpStatusEnum), string name = default(string))
        {
            this.HttpStatus = httpStatus;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for PropertiesErrorCategory and cannot be null");
            }
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertiesErrorCategory {\n");
        ...
        {
            return this.Equals(input as PropertiesErrorCategory);
        }

        /// <summary>
        /// Returns true if PropertiesErrorCategory instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertiesErrorCategory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertiesErrorCategory input)
        {
            if (input == null)
            {
                return false;
