...
namespace HubSpot.NET.Api
{
    ...
    public interface IPublicObjectSchemasApiSync : IApiAccessor
    {
        ...
        [Obsolete]
        ApiResponse<Object> DeleteCrmObjectSchemasV3SchemasObjectTypePurgePurgeWithHttpInfo(string objectType);
    ...
    public interface IPublicObjectSchemasApiAsync : IApiAccessor
    {
        ...
        [Obsolete]
        System.Threading.Tasks.Task DeleteCrmObjectSchemasV3SchemasObjectTypePurgePurgeAsync(string objectType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        [Obsolete]
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteCrmObjectSchemasV3SchemasObjectTypePurgePurgeWithHttpInfoAsync(string objectType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class PublicObjectSchemasApi : IPublicObjectSchemasApi
    {
        ...
        /// <returns></returns>
        public PublicObjectSchemasApi(HubSpot.NET.Client.Configuration configuration)
        {
        ...
        public PublicObjectSchemasApi(HubSpot.NET.Client.ISynchronousClient client, HubSpot.NET.Client.IAsynchronousClient asyncClient, HubSpot.NET.Client.IReadableConfiguration configuration)
        {
        ...
        /// <returns></returns>
        [Obsolete]
        public void DeleteCrmObjectSchemasV3SchemasObjectTypePurgePurge(string objectType)
        {
        ...
        /// <returns>ApiResponse of Object(void)</returns>
        [Obsolete]
        public HubSpot.NET.Client.ApiResponse<Object> DeleteCrmObjectSchemasV3SchemasObjectTypePurgePurgeWithHttpInfo(string objectType)
        {
            // verify the required parameter 'objectType' is set
            if (objectType == null)
            {
                throw new HubSpot.NET.Client.ApiException(400, "Missing required parameter 'objectType' when calling PublicObjectSchemasApi->DeleteCrmObjectSchemasV3SchemasObjectTypePurgePurge");
            }
        ...
        /// <returns>Task of void</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task DeleteCrmObjectSchemasV3SchemasObjectTypePurgePurgeAsync(string objectType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteCrmObjectSchemasV3SchemasObjectTypePurgePurgeWithHttpInfoAsync(objectType, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <returns>Task of ApiResponse</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<HubSpot.NET.Client.ApiResponse<Object>> DeleteCrmObjectSchemasV3SchemasObjectTypePurgePurgeWithHttpInfoAsync(string objectType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'objectType' is set
            if (objectType == null)
            {
