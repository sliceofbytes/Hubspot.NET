...
namespace HubSpot.NET.Api
{
    ...
    public partial class AuditLogsApi : IAuditLogsApi
    {
        ...
        /// <returns></returns>
        public AuditLogsApi(HubSpot.NET.Client.Configuration configuration)
        {
        ...
        public AuditLogsApi(HubSpot.NET.Client.ISynchronousClient client, HubSpot.NET.Client.IAsynchronousClient asyncClient, HubSpot.NET.Client.IReadableConfiguration configuration)
        {
        ...
        {
            HubSpot.NET.Client.ApiResponse<CollectionResponsePublicAuditLog> localVarResponse = GetCmsV3AuditLogsGetPageWithHttpInfo(objectId, userId, after, before, sort, eventType, limit, objectType);
        ...
        public HubSpot.NET.Client.ApiResponse<CollectionResponsePublicAuditLog> GetCmsV3AuditLogsGetPageWithHttpInfo(List<string> objectId = default(List<string>), List<string> userId = default(List<string>), string after = default(string), string before = default(string), List<string> sort = default(List<string>), List<string> eventType = default(List<string>), int? limit = default(int?), List<string> objectType = default(List<string>))
        {
            ...
            if (objectId != null)
            {
                localVarRequestOptions.QueryParameters.Add(HubSpot.NET.Client.ClientUtils.ParameterToMultiMap("multi", "objectId", objectId));
            }
            if (userId != null)
            {
                localVarRequestOptions.QueryParameters.Add(HubSpot.NET.Client.ClientUtils.ParameterToMultiMap("multi", "userId", userId));
            }
            if (after != null)
            {
            ...
            if (eventType != null)
            {
                localVarRequestOptions.QueryParameters.Add(HubSpot.NET.Client.ClientUtils.ParameterToMultiMap("multi", "eventType", eventType));
            }
            if (limit != null)
            {
            ...
            if (objectType != null)
            {
                localVarRequestOptions.QueryParameters.Add(HubSpot.NET.Client.ClientUtils.ParameterToMultiMap("multi", "objectType", objectType));
            }
        ...
        {
            HubSpot.NET.Client.ApiResponse<CollectionResponsePublicAuditLog> localVarResponse = await GetCmsV3AuditLogsGetPageWithHttpInfoAsync(objectId, userId, after, before, sort, eventType, limit, objectType, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
